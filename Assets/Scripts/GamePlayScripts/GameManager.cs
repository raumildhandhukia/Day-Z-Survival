...
public class GameManager : MonoBehaviour
{
	...
	[Header("ScoreManager")]
	public static float scorePerKill = 10;
		...
		if (streakCount > 2)
		{
			...
			switch (streakCount)
			{
				...
				case 7:
					...
					AudioManager.instance.PlaySound("cool", player.transform.position);
					break;
				case 8:
				case 9:
				case 10:
					...
					comboPraiseText.text = "Maniac";
					AudioManager.instance.PlaySound("maniac", player.transform.position);
					break;
				case 11:
				case 12:
				case 13:
				case 14:
					...
					comboPraiseText.text = "Savage";
					AudioManager.instance.PlaySound("savage", player.transform.position);
					break;
			}
			if (streakCount >= 15)
			{
				...
				comboPraiseText.text = "Legendary";
				AudioManager.instance.PlaySound("legendary", player.transform.position);
			}
		}
	...
	IEnumerator AnimateBanner()
	{
		...
		float animationAngle = 0;
		Vector3 originalPosition = new Vector3(0, 86, 0);
